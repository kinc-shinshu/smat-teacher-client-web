...
export class ExamResult extends Component {
  ...
  render() {
    ...
    const links = [
      ...
      { path: "/exams/" + examid + "/new", text: "結果" }
    ];
    const data = [
      { name: "問題1", challenge: [0, 5] },
      { name: "問題2", challenge: [0, 3] },
      { name: "問題1", challenge: [0, 5] },
      { name: "問題2", challenge: [0, 3] },
      { name: "問題1", challenge: [0, 5] },
      { name: "問題2", challenge: [0, 3] },
      ...
      { name: "問題1", challenge: [0, 5] },
      { name: "問題2", challenge: [0, 3] },
      { name: "問題3", challenge: [0, 4] }
    ];
    const data01 = [{ name: "正解", value: 6 }, { name: "不正解", value: 4 }];
    return (
      <div>
          ...
          <div class="row">
            ...
            <div class="col s9">
              <BarChart width={730} height={250} data={data}>
                ...
                <Tooltip />
                <Legend />
                <Bar dataKey="challenge" fill="#26a69a" />
              </BarChart>
            </div>
          </div>
        </div>
